...
const styleGroups: StyleGroup[] = [
  {
    ...
    nameEn: '日系風格',
    styles: [
      { id: 'anime', name: '日式動漫', nameEn: '日式動漫', prompt: 'anime style, cel shading, vibrant colors, manga' },
      { id: 'ghibli', name: '吉卜力風', nameEn: '吉卜力風', prompt: 'studio ghibli style, hand-drawn, fantasy, miyazaki' },
      { id: 'ukiyo-e', name: '浮世繪', nameEn: '浮世繪', prompt: 'ukiyo-e, japanese woodblock print, traditional art' },
      { id: 'kawaii', name: '可愛風', nameEn: '可愛風', prompt: 'kawaii, cute, pastel colors, chibi' },
      { id: 'manga', name: '漫畫風', nameEn: '漫畫風', prompt: 'manga style, black and white, screentone, comic' },
    ]
  },
  {
    id: 'lineart',
    ...
    styles: [
      ...
      { id: 'ink', name: '墨線', nameEn: '墨線', prompt: 'ink drawing, fine lines, black ink, traditional' },
      { id: 'lineart', name: '線稿', nameEn: '線稿', prompt: 'clean line art, vector style, outline' },
      { id: 'blueprint', name: '藍圖', nameEn: '藍圖', prompt: 'blueprint, technical drawing, architectural' },
      { id: 'wireframe', name: '線框', nameEn: '線框', prompt: 'wireframe, technical, schematic, diagram' },
    ]
  },
  {
    id: 'monochrome',
    ...
    styles: [
      ...
      { id: 'noir', name: '黑色電影', nameEn: '黑色電影', prompt: 'film noir, dramatic shadows, high contrast, vintage' },
      { id: 'charcoal', name: '炭筆', nameEn: '炭筆', prompt: 'charcoal drawing, textured, grayscale, artistic' },
  ...
  },
  {
    ...
    nameEn: '繪畫風格',
    styles: [
      { id: 'oil', name: '油畫', nameEn: '油畫', prompt: 'oil painting, artistic, brushstrokes, canvas texture' },
      ...
      { id: 'abstract', name: '抽象畫', nameEn: '抽象畫', prompt: 'abstract art, non-representational, geometric, modern' },
      { id: 'chinese-painting', name: '國畫', nameEn: '國畫', prompt: 'chinese ink painting, traditional, brushwork, sumi-e' },
    ]
  },
  {
    id: 'digital',
    ...
    nameEn: '數位藝術',
    styles: [
      { id: 'pixel', name: '像素藝術', nameEn: '像素藝術', prompt: 'pixel art, retro, 8bit, pixelated' },
      { id: 'voxel', name: '體素藝術', nameEn: '體素藝術', prompt: 'voxel art, 3d pixels, minecraft style, blocky' },
      { id: 'lowpoly', name: '低多邊形', nameEn: '低多邊形', prompt: 'low poly, geometric, 3d render, minimalist' },
      { id: 'vector', name: '矢量', nameEn: '矢量', prompt: 'vector art, flat design, clean lines, illustrator style' },
      { id: 'glitch', name: '故障藝術', nameEn: '故障藝術', prompt: 'glitch art, digital distortion, databending, corrupted' },
  ...
  },
  {
    ...
    styles: [
      ...
      { id: 'cinematic', name: '電影級', nameEn: '電影級', prompt: 'cinematic lighting, dramatic, film grain, professional photography' },
      ...
      { id: 'long-exposure', name: '長曝光', nameEn: '長曝光', prompt: 'long exposure, motion blur, light trails, smooth' },
  ...
  },
  {
    ...
    nameEn: '奇幻風格',
    styles: [
      { id: 'cyberpunk', name: '賽博龐克', nameEn: '賽博龐克', prompt: 'cyberpunk, neon lights, futuristic, sci-fi' },
      { id: 'steampunk', name: '蒸汽龐克', nameEn: '蒸汽龐克', prompt: 'steampunk, victorian, brass gears, industrial' },
      { id: 'gothic', name: '哥特', nameEn: '哥特', prompt: 'gothic, dark, ornate, dramatic, victorian' },
      { id: 'surreal', name: '超現實', nameEn: '超現實', prompt: 'surrealism, dreamlike, impossible, dali style' },
    ]
  },
  {
    id: 'special',
    ...
    styles: [
      ...
      { id: 'smoke', name: '煙霧', nameEn: '煙霧', prompt: 'smoke effect, misty, ethereal, atmospheric, fog' },
      { id: 'double-exposure', name: '雙重曝光', nameEn: '雙重曝光', prompt: 'double exposure, layered images, blend mode, artistic overlap' },
    ]
  },
]
